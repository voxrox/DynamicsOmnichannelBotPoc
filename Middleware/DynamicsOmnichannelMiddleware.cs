...
using DynamicsOmnichannelBotPoc.DynamicsOmnichannel;
using Microsoft.Bot.Schema;
using Newtonsoft.Json;

namespace DynamicsOmnichannelBotPoc.Middleware
{
    public class DynamicsOmnichannelMiddleware : Microsoft.Bot.Builder.IMiddleware
    {
