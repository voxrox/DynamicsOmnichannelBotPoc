...
using DynamicsOmnichannelBotPoc.AdaptiveCards;
using DynamicsOmnichannelBotPoc.DemoConversation;

namespace DynamicsOmnichannelBotPoc.Bots
{
    public class DynamicsOmnichannelAgentBot : ActivityHandler
    {
       ...
       protected override async Task OnMembersAddedAsync(IList<ChannelAccount> membersAdded, ITurnContext<IConversationUpdateActivity> turnContext, CancellationToken cancellationToken)
            ...
            else
            {
                switch (text.ToLower())
                {
                    ...
                    case "adaptive card":
                        ...
                        reply.Attachments.Add(DynamicsOmnichannelBotPoc.AdaptiveCards.AdaptiveCards.CreateAdaptiveCardAttachment("store.json"));
                        break;
                    case "microsoft article":
                        // Display an Adaptive Card for support article
                        reply.Attachments.Add(DynamicsOmnichannelBotPoc.AdaptiveCards.AdaptiveCards.CreateAdaptiveCardAttachment("article.json"));
                        break;
        ...
        private async Task<string> GetAdaptiveCardsReplyText(IMessageActivity reply, string replyText, ITurnContext turnContext, CancellationToken cancellationToken)
        {
            ...
            reply.Attachments.Add(DynamicsOmnichannelBotPoc.AdaptiveCards.AdaptiveCards.CreateAdaptiveCardAttachment(adaptiveCard));
        ...
        private string GetSuggestedActionsReplyText(IMessageActivity reply, string replyText)
        {
            ...
            reply.SuggestedActions = DynamicsOmnichannelBotPoc.AdaptiveCards.AdaptiveCards.CreateSuggestedAction(suggestedActions);
